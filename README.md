# ⚔DotNet Exercises
[DotNetGuide专栏C#/.NET/.NET Core编程技巧练习集](https://github.com/YSGStudyHards/DotNetGuide)：C#/.NET/.NET Core编程常用语法、算法、技巧、中间件、类库、工作业务实操练习集，配套详细的文章教程和代码示例，助力快速掌握C#/.NET/.NET Core中各种编程常用语法、算法、技巧、中间件、类库、工作业务实操等等。
...
- [**107、EasySQLite**](https://github.com/YSGStudyHards/EasySQLite)：[将 EasySQLite 解决方案文件格式从 .sln 升级为更简洁的 .slnx](https://mp.weixin.qq.com/s/fNYD9GgbRik4gicn8DDT9g)
- [**108、EasySQLite**](https://github.com/YSGStudyHards/EasySQLite)：[在 .NET 9 中使用 Mapster 快速、高效的实现对象映射](https://mp.weixin.qq.com/s/QFEbHE2EWzzZN9VvnUwD4A)
- [**109、FlaUIExercise**](https://github.com/YSGStudyHards/DotNetExercises/tree/master/FlaUIExercise)：[一个 .NET 开源免费、功能强大的 UI 自动化库](https://mp.weixin.qq.com/s/PE4S-fUyeG7U8Z78NYu6Rw)
- [**110、Visual Studio 常用快捷键**](https://mp.weixin.qq.com/s/6Ekqufb4r2VvQGd9TifpEg)
- [**111、Visual Studio的 奇淫技巧**](https://mp.weixin.qq.com/s/4vo2OvWdj9fMrKCIKi70Dg)
- [**112、使用 Visual Studio 分析.NET Dump**](https://mp.weixin.qq.com/s/JDCsr-sH1Z7jMEcxNfjbmg)
- [**113、使用 Visual Studio 调试 .NET源代码**](https://mp.weixin.qq.com/s/LnFV2K2CoqiorArBM8XkDg)
- [**114、Visual Studio 2022 Git多存储库管理**](https://mp.weixin.qq.com/s/-X04QR3rgXAubCnMVGJosQ)
- [**115、Visual Studio 2022 进行文件差异比较**](https://mp.weixin.qq.com/s/7eiN_RAf_DfPXM86pQOuuw)
- [**116、Visual Studio IDE 详细介绍&使用文档**](https://learn.microsoft.com/zh-cn/visualstudio/ide/?view=vs-2022)
- [**117、在 Visual Studio 中查看EF Core查询计划**](https://mp.weixin.qq.com/s/m0UKt78brvZVx5-GODlIKA)
- [**118、Visual Studio 文件编码显示与修改扩展插件**](https://mp.weixin.qq.com/s/EkxAdqceID7PCkNGtNSqwg)
- [**119、Visual Studio 实用的搜索、查找、替换技巧**](https://mp.weixin.qq.com/s/Cijr_e1qOjNXOS1TtZjxgA)
- [**120、Visual Studio 中使用 CodeGeeX AI 编程助手**](https://mp.weixin.qq.com/s/1r4QK1bYDH7MdOTNLZli-g)
- [**121、合理使用 Visual Studio 2022 内置任务列表-TODO**](https://mp.weixin.qq.com/s/Cc2kgPBjj-mjVigxceKtRw)
- [**122、Visual Studio 将 JSON 格式数据自动转化为对应的类**](https://mp.weixin.qq.com/s/-5dL_b5pMLV0LQoVMsFjjQ)
- [**123、Visual Studio 使用 Git 忽略不想上传到远程仓库的文件**](https://mp.weixin.qq.com/s/T2Ya3NWlv1gQN7_FQcHWnw)
- [**124、Visual Studio 使用 GitHub Copilot 提高 .NET 开发工作效率**](https://mp.weixin.qq.com/s/E731dDi00Bf_uL1iU2roGQ)
- [**125、Visual Studio 使用 Web Deploy 发布应用到指定服务器的 IIS 中**](https://mp.weixin.qq.com/s/Z_nZ31j7X_fgGH4NG2sFBg)
- [**126、一款实用的 Visual Studio 发布部署插件，助力提高部署效率！**](https://mp.weixin.qq.com/s/U0oq-6jq0NCBMmZ81sZj-Q)
- [**127、Visual Studio 2022 中的 EF Core 反向工程和模型可视化工具**](https://mp.weixin.qq.com/s/nnJndy3C1VwZz5Yu1yPd_A)
- [**128、使用 Visual Studio 快速创建 NuGet 程序包并发布到 NuGet 官网**](https://mp.weixin.qq.com/s/bvTwu8aiKq2U3WoJ0zMkjw)
- [**129、Visual Studio 现已支持新的、更简洁的解决方案文件（slnx）格式**](https://mp.weixin.qq.com/s/ysq58eg3Eiyie_0wY_k_Gg)
- [**130、Visual Studio 2026 预览体验版现已发布，一起来看看带来哪些新功能！**](https://mp.weixin.qq.com/s/b5QWP8Bj9YJMRx2adyjDRg)
- [**131、Visual Studio 2026 正式版下载与安装详细教程（附带产品密钥）！**](https://mp.weixin.qq.com/s/wbZiTPjhKlFOeU3MgIbq0A)
- [**132、精选 4 款开源免费、美观实用的 MAUI UI 组件库，助力轻松构建美观且功能丰富的应用程序！**](https://mp.weixin.qq.com/s/P5_aP5H_DXDla8HARyNSjA)
- [**133、推荐 4 款基于 .NET 开源、功能强大的文件管理工具，助力高效的整理文件与文件夹！**](https://mp.weixin.qq.com/s/Y5Z0C0c3aoUKCjGHAdLIKg)
- [**134、精选 6 款开源的 WinForm UI 控件库，轻松让你的老牌 WinForm 应用焕然一新！**](https://mp.weixin.qq.com/s/l4ccmjKzodcwhxYDRTdukg)
- [**135、精选 5 款 .NET 开源、实用的商城系统（Shop），快速商城二开利器！**](https://mp.weixin.qq.com/s/jmACitN34VgTdy6ByDetvg)
- [**136、精选 8 个基于 .NET 开源、功能强大的 AI 和 LLM 相关项目框架**](https://mp.weixin.qq.com/s/qxjUYO2U-TCTd0JmEtbehA)
- [**137、从零开始：C# 拼音首字母搜索、字符串编码、关键词高亮实现**](https://mp.weixin.qq.com/s/ptld_nxUy2eM0SRG8AGiig)
- [**138、TypedSql：在 C# 类型系统上实现一个 SQL 查询引擎**](https://mp.weixin.qq.com/s/WkS6qjDslM2UWDdjpQsjuw)
